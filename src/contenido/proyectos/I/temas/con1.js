...
function irAEvaluacionSiFinalizaContenido() {
  ...
  if (teoriaIndex === teoriasKeys.length - 1) {
    // Espera 1 segundo y redirige (puedes ajustar el tiempo o poner un botón si prefieres)
    setTimeout(() => {
      window.location.href = "/src/contenido/evaluacion/pro1/eva_pro1_con1.html";
    }, 1000);
  }
}
